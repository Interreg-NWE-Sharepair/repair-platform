        ...
        <div class="flex flex-wrap -mx-3 -mt-6">
            <div class="w-full px-3 mt-6 xl:w-1/3">
                <div class="flex flex-col h-full xs:flex-row xl:flex-col" style="gap: 1.5rem;">
                    <div
                        class="flex items-center justify-center flex-grow w-full p-4 text-center bg-white xs:w-1/2 md:w-full rounded-card sm:p-6">
                        <h3 class="text-black">
                    ...
                    <div
                        class="flex flex-wrap items-center justify-center flex-grow w-full p-4 text-center bg-white xs:w-1/2 md:w-full sm:p-6 rounded-card">
                            ...
                            <div class="w-1/2 px-2 mt-6 sm:w-1/4">
                                <div class="relative w-full h-24">
                                    <div class="w-32 mx-auto -rotate-90">
                                        ...
                                        @endphp
                                        <div class="h-8 border border-secondary-hover" aria-hidden="true"
                                             style="width: {{$width }}%; background-color: rgba(156, 121, 151, {{$width}}%)"></div>
                                        <div class="text-left">
                                                <span
                                                    class="text-4xl font-black tracking-wider">{{ $data['devices']['repaired'] }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-5">
                            ...
                            <div class="w-1/2 px-2 mt-6 sm:w-1/4">
                                <div class="relative w-full h-24">
                                    <div class="w-32 mx-auto -rotate-90">
                                        ...
                                        @endphp
                                        <div class="h-6 border border-secondary-hover" aria-hidden="true"
                                             style="width: {{$width }}%; background-color: rgba(156, 121, 151, {{$width}}%)"></div>
                                        <div class="text-left">
                                                <span
                                                    class="text-4xl font-black tracking-wider">{{ $data['devices']['end_of_life'] }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-5">
                            ...
                            <div class="w-1/2 px-2 mt-6 sm:w-1/4">
                                <div class="relative w-full h-24">
                                    <div class="w-32 mx-auto -rotate-90">
                                        ...
                                        <div class="text-left">
                                                <span
                                                    class="text-4xl font-black tracking-wider">{{ $data['devices']['archived'] }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-5">
                            ...
                            <div class="w-1/2 px-2 mt-6 sm:w-1/4">
                                <div class="relative w-full h-24">
                                    <div class="w-32 mx-auto -rotate-90">
                                        ...
                                        <div class="text-left">
                                                <span
                                                    class="text-4xl font-black tracking-wider">{{ $data['devices']['to_repair'] }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-5">
                  <span class="inline-block text-sm leading-none">
                    {{ __('messages.devices_to_repair') }}
                        ...
                        <div class="w-full pt-6 mt-6 border-t border-gray-400">
                            <a href="{{ LaravelLocalization::getURLFromRouteNameTranslated(app()->getLocale(), 'routes.repairer_register_index', ['locationCode' => $data['organisation']->slug]) }}"
                        ...
                        <div class="flex flex-wrap justify-center -mx-3 -mt-12">
                            <div class="order-1 w-full px-3 mt-6 sm:order-2 sm:w-1/3">
                                <div class="flex items-end justify-center h-full">
                                    <svg width="184px" height="129px" viewBox="0 0 184 129" version="1.1"
                                        ...
                                        <g id="REPLOG-362" stroke="none" stroke-width="1" fill="none"
                                           fill-rule="evenodd">
                                            <g id="Repair-Connects-→-Organisatie-(publiek)"
                                               transform="translate(-634.000000, -1047.000000)" stroke="#333333"
                                               stroke-width="0.5">
                                                           ...
                                                           transform="translate(260.000000, 71.000000)">
                                                            <g id="Group-18"
                                                               transform="translate(201.500000, 0.000000)">
                                                                <rect id="Rectangle" fill="#FFFFFF" x="0.25"
                                                                      y="13.25" width="155.5" height="115.5"></rect>
                                                                <path
                                                                ...
                                                                <g id="Group-13"
                                                                   transform="translate(127.500000, 0.000000)">
                                                                    ...
                                                                    <circle id="Oval" fill="#FF9623" cx="28" cy="28"
                                                                            r="27.75"></circle>
                            ...
                            <div class="order-2 w-full px-3 mt-6 sm:order-1 sm:w-1/3">
                                <div class="flex items-end justify-center h-full">
                                    <svg width="172px" height="104px" viewBox="0 0 172 104" version="1.1"
                                         xmlns="http://www.w3.org/2000/svg"
                                         xmlns:xlink="http://www.w3.org/1999/xlink">
                                        <title>Rank 2</title>
                                        <g id="REPLOG-362" stroke="none" stroke-width="1" fill="none"
                                                           ...
                                                           transform="translate(260.000000, 71.000000)">
                                                            <g id="Group-19"
                                                               transform="translate(0.000000, 25.000000)">
                                                                <rect id="Rectangle" fill="#DCDDDE" x="0" y="0"
                                                                ...
                                                                <g id="Group-22"
                                                                   ...
                                                                   stroke="#333333" stroke-width="0.5">
                                                                    <path
                                                                        ...
                                                                        id="Path-2"></path>
                                                                    <line x1="8.5" y1="104" x2="8.5" y2="8.25"
                                                                          id="Path-3"></line>
                                                                    <line x1="12.5" y1="104" x2="12.5" y2="12.25"
                                                                          id="Path-3"></line>
                                                                    <line x1="4.5" y1="104" x2="4.5" y2="4.25"
                                                                          id="Path-3"></line>
                                                                </g>
                                                            </g>
                                                        </g>
                                                            ...
                                                            <g id="Group-20"
                                                               transform="translate(403.000000, 37.000000)">
                                                                <rect id="Rectangle" stroke="#333333"
                                                                      stroke-width="0.5" fill="#DBBAB4" x="0.25"
                                                                      y="0.25" width="155.5" height="91.5"></rect>
                                                                <text id="18"
                                                                      font-family="TitilliumWeb-Black, Titillium Web"
                                                                      font-size="36" font-weight="800"
                                                                      line-spacing="20" fill="#333333">
