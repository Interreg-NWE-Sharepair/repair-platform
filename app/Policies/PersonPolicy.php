...
class PersonPolicy extends AbstractPolicy
{
    ...
    public function view(User $user, Person $person)
    {
        return $this->checkPermissions($user, [
                'nova-view-entity',
                'nova-events',
            ]) && $this->isEmployeeOfModel($user, $person, [
                'entity-admin',
                'event-organizer',
            ]);
    }
    ...
    {
        return $this->checkPermissions($user, ['nova-view-entity']) && $this->isEmployeeOfModel($user, $person, ['entity-admin']);
    }
    ...
    {
        return false;
        return $this->checkPermissions($user, ['nova-admin', 'nova-view-entity']);
    }
