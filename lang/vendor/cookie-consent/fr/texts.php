...
return [
    ...
    'settings_text_repgui' => 'Notre site web utilise trois niveaux de cookies. Vous pouvez adapter vos préférences à tout moment. Vous trouverez davantage d\'informations sur les cookies et la manière dont nous les utilisons dans notre <a class="text-base text-black underline hover:text-primary-hover" href=":policyUrl">politique en matière de cookies</a>.',
];
