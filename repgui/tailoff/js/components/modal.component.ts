...
const siteLang = document.documentElement.lang ? document.documentElement.lang : "nl";

export class ModalComponent {
  private lang = require(`../i18n/s-modal-${siteLang}.json`);
  ...
  private options = {
    ...
    nextHTML: `<svg class="icon" aria-hidden="true">
                  <use xlink:href="/repgui/icon/sprite.svg#chevron-right"></use>
              </svg>`,
    prevHTML: `<svg class="icon" aria-hidden="true">
                  <use xlink:href="/repgui/icon/sprite.svg#chevron-left"></use>
              </svg>`,
    initTriggers: true,
    allowClose: true,
    onClose: null,
