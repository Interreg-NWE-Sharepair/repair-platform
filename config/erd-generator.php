...
return [
    ...
    */
    'whitelist' => [
        \App\Models\ActivitySector::class,
        \App\Models\CommonDeviceTypeIssue::class,
        \App\Models\CompletedRepairStatus::class,
        \App\Models\User::class,
        \App\Models\Device::class,
        \App\Models\DeviceType::class,
        \App\Models\Employee::class,
        \App\Models\Event::class,
        \App\Models\Location::class,
        \App\Models\Organisation::class,
        \App\Models\Person::class,
        \App\Models\RepairLog::class,
        \App\Models\RepairBarrier::class,
        \App\Models\RepairLogLink::class,
        \App\Models\RepairLogNote::class,
        \App\Models\ImageCategory::class,

        \App\Models\RepairGuidanceFormDeviceTypeIssue::class,
        \App\Models\RepairGuidanceFormLog::class,
        \App\Models\RepairTutorial::class,
     ...
     */
    'table' => [
        'header_background_color' => '#71b8c5',
