...
return [
     ...
     */
    'path_generator' => App\Helpers\EnvironmentMediaPathGenerator::class,
    ...
    'temporary_uploads_allowed_extension' => \Spatie\MediaLibraryPro\Support\DefaultAllowedExtensions::all()
    /*'temporary_uploads_allowed_extensions' => [
        // your extensions
        'jpeg', 'jpeg', 'png', 'bmp', 'gif', 'svg', 'webp'
    ],*/
];
